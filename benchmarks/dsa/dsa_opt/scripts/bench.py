...
working_path = '/home/christos/dev/ser1de/'
sys.path.insert(0, os.path.join(os.path.dirname(__file__), working_path + 'scripts'))

from proto_generator import *

benchmark_path = working_path + 'benchmarks/dsa_opt/'
