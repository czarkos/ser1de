...
benchmark_path = '/home/christos/dev/ser1de/benchmarks/end2end_sensitivity/scripts/'
...
def end2end_plot(df, name):
    # Calculate required sums for each plot line
    df['ser1de'] = df['scatter_schema'] + df['dsa_scatter'] + df['decompression'] + df['compression'] + df['gather_schema'] + df['dsa_gather'] + df['allocation']
