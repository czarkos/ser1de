...
ser1de_path = os.path.abspath(os.path.join(SCRIPT_DIR, '..', '..', '..'))
protobuf_path = os.path.join(ser1de_path, 'protobuf')
sys.path.insert(0, os.path.join(ser1de_path, 'scripts'))

from proto_generator import *

benchmark_path = os.path.abspath(os.path.join(SCRIPT_DIR, '..')) + '/'
